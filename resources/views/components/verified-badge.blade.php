<div class="verified-wrapper" data-tooltip="Verified User">
    <svg viewBox="0 0 24 24" width="18" height="18" fill="#04a01e">
...
.verified-wrapper:hover::after,
.verified-wrapper:hover::before {
    opacity: 1;
}
</style>