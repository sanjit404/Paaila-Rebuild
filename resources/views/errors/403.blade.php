    ...
    <div class="error-left">
        <div class="error-left-inner">
            ...
            <div class="error-tagline">
                <h1>Access denied.</h1>
                <p>You don’t have permission to view this page. Please return to a page you can access.</p>
            </div>
        </div>
    </div>
    ...
    <div class="error-right">
        <div class="error-card">
            <div class="error-code">
                <i class="fa-solid fa-lock error-digit"></i>
            </div>

            <h2 class="error-title">Forbidden</h2>

            <p class="error-message">
                This action is restricted for your account or role.
            </p>
            ...
            <div class="error-footer">
                If you think this is a mistake, contact support or the administrator.
            </div>
        </div>
    </div>
</div>
