    ...
    <div class="error-left">
        <div class="error-left-inner">
            ...
            <div class="error-tagline">
                ...
                <p>The page you’re trying to reach doesn’t exist or the route may have changed.</p>
            </div>
        </div>
    </div>
    ...
    <div class="error-right">
        <div class="error-card">
            <div class="error-code">
                <i class="fa-solid fa-4 error-digit"></i>
                <i class="fa-solid fa-0 error-digit"></i>
                <i class="fa-solid fa-4 error-digit"></i>
            </div>
            ...
            <p class="error-message">
                Double-check the URL or head back to the homepage to continue your trek.
            </p>
